...
| (3) 구성원 | 연지혜(2171029) 역할: 팀장, 기획, 개발(단계로직 설계 구현 및 단계별 오브젝트 연결, Object 상호작용 구현, Outline 시스템), 3D 모델링, 맵 배치 및 수정 <br> 윤경민(2171032) 역할: 팀원, 개발(HandTracking, MR 환경, TTS 음성 시스템, 실패/힌트 시스템, 물체 상호작용), 3D 모델링 <br> 남연정(2176122) 역할: 팀원, 기획, 개발, 3D 모델링(완강기 지지대, 밧줄, 고리 등) |
| (4) 지도교수 | 김영준 교수 |
| (5) 트랙  | 산학 |
...
| (8) 주요 Link | GitHub: https://github.com/217-etc/VR-Security |
