...
| (7) 과제 내용 요약 | 이 과제는 K-pop 안무를 혼자 연습하는 사용자의 시간·비용 부담과 학습 효율 문제를 해결하기 위해 설계되었습니다. 실시간으로 사용자의 동작을 분석하기 위해 MediaPipe를 활용하고, 안무 시각화를 위해 SAM2와 OpenCV를 사용하며, 사용자의 동기부여를 강화를 위해 Unity 기반 가상 아이돌과의 챌린지 모드를 구현하였습니다. 현재까지 MediaPipe로 동작 유사도 분석, SAM2와 OpenCV로 윤곽선 시각화, Unity로 아바타 안무 영상 제작을 완료하였습니다.  |
