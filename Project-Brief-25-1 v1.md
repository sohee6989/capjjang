...
# Team-43
| (1) 과제명 | MANSION-VOMIC : 심리적 공포 체험을 원하는 게이머를 위해 보이스클로닝, STT-LLM-TTS를 이용한 방탈출 공포게임임 |
|:---  |---  |
| (2) 팀 번호/이름 | 43-코코넛 |
...
| (7) 과제 내용 요약 | 플레이어가 음성을 통해 동료 플레이어와 소통하며 저택을 탈출하는 방탈출 공포게임. <br> 플레이어의 목소리를 클로닝한 뒤, AI 기반 기술 (STT, TTS, LLM)을 활용해 적대적 개체와 동료 플레이어를 구별하기 어렵게 만들어 시각적인 공포 요소 의존도를 낮추고 심리적 공포를 자연스럽게 유도 하고자 한다. <br>이를 통해 플레이어에게 새로운 공포 경험을 제공하는 것을 목표로 한다. |
